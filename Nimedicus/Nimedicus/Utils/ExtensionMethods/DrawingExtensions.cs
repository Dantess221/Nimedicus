...
namespace Nimedicus.Utils.ExtensionMethods
{
    public static class DrawingExtensions
    {
        ...
        {
            SolidColorBrush resultBrush = new SolidColorBrush(Color.FromArgb((byte)(byte.MaxValue * opacityCoeficient), brush.Color.R, brush.Color.G, brush.Color.B));
            return resultBrush;
        }
        ...
        public static void ChangeColor(this Drawing drawing, Brush brush, bool isColorShiftFill = true, bool isColorShiftStroke = true, bool isColorShiftInvisible = true)
        {
            if (brush == null)
                return;

            if (drawing is DrawingGroup)
                ChangeColorForDrawingGroup(drawing as DrawingGroup, brush, isColorShiftFill, isColorShiftStroke, isColorShiftInvisible);
            ...
            else if (drawing is GeometryDrawing)
            {
                ...
                if (isColorShiftFill && (isColorShiftInvisible || (geo.Brush != null && geo.Brush.Opacity != 0 && (brushAsSolid == null || brushAsSolid.Color.A != 0))))
                {
        ...
        public static void ChangeColor(this Drawing drawing, Color color, double? colorOpacity = null, bool isColorShiftFill = true, bool isColorShiftStroke = true, bool isColorShiftInvisible = true)
        {
        ...
        private static void ChangeColorForDrawingGroup(DrawingGroup group, Brush brush, bool isColorShiftFill = true, bool isColorShiftStroke = true, bool isColorShiftInvisible = true)
        {
        ...
        public static Drawing GetItemByName(this Drawing drawing, string name)
        {
            ...
            {
                return GetItemByNameRecursive(drawingGroup, name);
            }
        ...
        private static Drawing GetItemByNameRecursive(DrawingGroup drawingGroup, string name, out DrawingGroup foundItemParent)
        {
            Drawing foundItem;
            if (drawingGroup != null)
            {
        ...
        public static string GetFirstNamedItemName(this Drawing drawing)
        {
            ...
            if (drawingGroup != null)
            {
                return GetFirstNamedItemNameRecursive(drawingGroup);
            }
        ...
        private static string GetItemByGetItemByNameRecursiveNameRecursive(DrawingGroup drawingGroup, out DrawingGroup foundItemParent)
        {
            ...
            foreach (var child in drawingGroup.Children)
            {
                ...
                if (child is DrawingGroup)
                {
                    var foundItemName = GetItemByGetItemByNameRecursiveNameRecursive((DrawingGroup)child, out foundItemParent);
        ...
        public static void SetItemByName(this Drawing drawing, Drawing setItem, string name)
        {
            ...
            if (drawingGroup != null)
            {
                SetItemByNameRecursive(drawingGroup, setItem, name);
            }
        }
        ...
        private static void SetItemByNameRecursive(DrawingGroup drawingGroup, Drawing setItem, string name)
        {
            ...
            foreach (var child in drawingGroup.Children)
            {
                if (SharpVectors.Runtime.SvgObject.GetId(child) == name)
                {
        ...
        public static void SetOpacityForGroupByName(this Drawing drawing, string name, double opacity)
        {
            ...
            if (drawingGroup != null)
            {
                SetOpacityForGroupByNameRecursive(drawingGroup, name, opacity);
            }
        }
